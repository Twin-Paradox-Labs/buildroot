...
# The 20-bit DAC has an output range of 0-5V
...
devmem2_write 725 $((limitMaxVal & 0xFFFF))          # Sets the limiter max_in[15:0] at bram addr = 725
devmem2_write 726 $(((limitMaxVal >> 16) & 0xFF))    # Sets the limiter max_in[23:16] at bram addr = 726
devmem2_write 727 $((limitMinVal & 0xFFFF))          # Sets the limiter min_in[15:0] at bram addr = 727
devmem2_write 728 $(((limitMinVal >> 16) & 0xFF))    # Sets the limiter min_in[23:16] at bram addr = 728

# Set Sweep Generator MAX
devmem2_write 719 $((digitalSweepMax & 0xFFFF))  # Sets the sweep generator max_in[15:0]
devmem2_write 720 $(((digitalSweepMax >> 16) & 0xFF)) # Sets the sweep generator max_in[19:16]

# Set Sweep Generator MIN
devmem2_write 721 $((digitalSweepMin & 0xFFFF)) # Sets the sweep generator min_in[15:0]
devmem2_write 722 $(((digitalSweepMin >> 16) & 0xFF)) # Sets the sweep generator min_in[19:16]

# Set Sweep Generator STEP_SIZE
devmem2_write 723 $stepSize
