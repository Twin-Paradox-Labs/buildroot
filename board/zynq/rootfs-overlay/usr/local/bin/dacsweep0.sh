...
# The 16-bit DAC has an output range of -5 to +5V
OUTPUT_RANGE_MAX=5.0
OUTPUT_RANGE_MIN=-5.0
...
# Do a linear remapping of the sweep voltage value [-5.0, 5.0] to the 20-bit digital value range [-524288, 524287]:
